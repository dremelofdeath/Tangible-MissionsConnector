  ...
  <body>
    ...
    <div id="tabs" style="display: none">
      <ul>
        ...
        <li><a href="#network-tab" style="display: none">My Network</a></li>
        <li><a href="#invite-tab" style="display: none">Invite</a></li>
      </ul>
      <div id="ajax-spinner">
    ...
    <div id="cmc-footer" style="display: none">
      <div class="leftside">
        <a href="#" id="report-problem" style="display: none;">Report a Problem</a> : <a href="#" id="contact-link" style="display: none;">Contact Us</a>
      </div>
      <div class="rightside">
