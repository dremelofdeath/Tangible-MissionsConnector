...
<br><br><u>2) Getting the word out about our application:</u> Through our innovative marketing program, $1 that you give could expose well over 1,000 people to Misssions Connector. The bigger the database is, the more useful it will be to you and the people that so desperately need our help.
...
<br><br>An e-mail system that automatically notifies you when new results come up for a search you've done before. (Of course we will ONLY send you this sort of e-mail if you ask for it and only for the searches you are interested in.) This will save people the time of coming back over and over and will make connections happenfaster. 

<br><br>A discounted misssions store that will give discounted prices on everything fro donated medical supplies to (someday) plane tickets and rural travel recommendations. 

<br><br>However, we can't make any of this happen without your committed support. 

<br><br>So please use the secure paypal docnation box below and give a meaningful gift to help us build the world's most effective Christian missions application. When you reach the donation page, please note that we are not yet a tax exempt organization and so your gifts will not be tax deductible (yet). What we can promise is that what you give will go 100% back to the core missions costs associated with Christian Missions Connector. <br><br><br>"; 
